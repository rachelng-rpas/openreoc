...
Use this before selecting Pathway 1 for a mission:

- [ ] Can you physically control access to the entire operational area (including ground risk buffer)?
- [ ] Are all persons within the area either RPA crew or active participants?
...
| Requirement | Detail |
|---|---|
| **Environment** | Controlled — physical access control prevents third-party entry |
| **RPA weight** | ≤ 25 kg |
| **Operator** | Must hold a current ReOC |
| **Consent** | Written informed consent from every active participant |
