...
| Operational volume | The operational volume comprises the flight geography and the contingency volume. Must consider the position-keeping capabilities of the RPA in 4D space (latitude, longitude, height, and time). In particular, the accuracy of the navigation solution, the flight technical error of the RPA, as well as the path definition error (e.g. map error) and latencies will be considered and addressed in this determination. If the RPAS leaves the operational volume, emergency procedures must be activated immediately | |
